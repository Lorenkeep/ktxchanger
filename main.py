...
#importamos configparser para ficheros de configuracion
import configparser
import json
import requests
...
class Exchanger(ttk.Frame):
    def __init__(self, parent):
        ...
        #El trace hace que se siga los cambios "la w es porque es escritura"
        ...
        self.outQuantityLbl.pack(side=TOP, fill=X, padx=DEFAULTPADDING, pady=DEFAULTPADDING, ipady=0)
    ...
    def convertirDivisas(self, *args):
        ...
        _to = _to[:3]
        symbols = _from+","+_to
        #la linea de abajo es lo mismo que la de arriba
        ##symbols = "{},{}".format(_from, _to)
